...
INSERT INTO `tb_cargo` VALUES (1,'Novo...'),(2,'LAVADOR'),(3,'LOCADOR'),(4,'MECANICO'),(5,'MANOBRISTA'),(6,'GERENTE');
...
INSERT INTO `tb_marca` VALUES (1, 'Novo...'),(2,'LIFAN'),(3,'HONDA'),(4,'FIAT'),(5,'FORD'),(6,'CHEVROLET'),(7,'JEEP'),(8,'VOLKSWAGEM'),(9,'KIA'),(10,'MITSUBISHI'),(11,'HYUNDAI'),(12,'BMW'),(13,'RENAULT'),(14,'TOYOTA'),(15,'AUDI'),(16,'BUGATTI'),(17,'FERRARI'),(18,'SUBARU'),(19,'ASTON MARTIN'),(20,'PORCHE');
...
INSERT INTO `tb_modelo` VALUES (1, 'Novo...'),(2,'RACING'),(3,'SEDAN'),(4,'PICKUP'),(5,'UTILITÁRIO'),(6,'WAGON'),(7,'HATCH'),(8,'COUPÊ'),(9,'SUV'),(10,'OFF ROAD');
...
add column TB_CLIENTE_STATUS varchar(7) default 'ATIVO';

alter table tb_cargo
add column TB_CARGO_STATUS varchar(7) default 'ATIVO';

alter table tb_modelo
add column tb_modelo_status varchar(12) default 'DISPONIVEL';

alter table tb_marca
add column tb_marca_status varchar(12) default 'DISPONIVEL';
